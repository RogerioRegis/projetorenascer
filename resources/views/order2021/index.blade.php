...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h4 class="h3 mb-0 text-primary">Relatórios Ano Calendário 2021</h4>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover table-green" id="dataTable" width="100%" cellspacing="0">
						...
						@foreach ( $vinte_um_orders as $order )
    					...
    					<tr class="small">
    						...
    						<td class="text-center">
    							<div class="btn-group" role="group" aria-label="...">
    								...
    								<!-- Imprimir -->
    								<a href="{{ url('order2021', $order->id) }}" class="btn btn-primary btn-circle btn-sm" target="_blanck" title="Imprimir"><i class="fas fa-print"></i></a>
    							</div>
    						</td>
    					</tr>
