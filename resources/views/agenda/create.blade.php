...
<div class="card shadow mb-4 bg-dark-mode border-dark">
	...
	<div class="card-header py-3 bg-dark-menu border-dark">
		<h5 class="m-0 font-weight-bold text-danger"><i class="fas fa-fw fa-table"></i> CRIANDO ORÇAMENTO</h5>
	</div>

	<!-- Formulário -->
	<div class="card-body text-gray-600 font-weight-bold">

		<form id="create_form" method="POST" action="{{ route('agenda.store') }}" enctype="multipart/form-data">
			@method('POST')
			@csrf
			...
			<div class="row">
				...
				<div class="col-md-7">
					...
					<div class="form-row">
						...
						<div class="col">
							<div class="form-group">
								...
								<input name="address" type="text" class="form-control text-primary">
							</div>
						</div>
						<div class="col">
							<div class="form-group">
								<label for="bairro">BAIRRO</label>
								<input name="bairro" type="text" class="form-control text-primary">
							</div>
						</div>
						-->
					...
					<div class="form-row">
						<div class="col">
							<div class="form-group">
								<label for="uf">CIDADE - UF</label>
								<input name="uf" class="form-control text-primary" type="text" >
							</div>
						</div>
						<div class="col">
							<div class="form-group">
					...
					<div class="form-row">
						...
						<div class="col-8">
							...
							<input class="form-control mb-1 text-white text-uppercase bg-dark-mode border-dark text-uppercase" id="d1" name="d1" type="text" placeholder="CAMPO 1">
						</div>
						<div class="col-2">
					...
					<div class="form-row">
						...
						<div class="col-8">
							<input class="form-control mb-1 text-white text-uppercase bg-dark-mode border-dark text-uppercase" id="d2" name="d2" type="text" placeholder="CAMPO 2">
						</div>
						<div class="col-2">
					...
					<div class="form-row">
						<div class="col-2">
							<input class="form-control mb-1 text-white text-uppercase bg-dark-mode border-dark text-center" id="q15" name="q15" type="text" placeholder="QTD15"> 
						</div>
						<div class="col-8">
							<input class="form-control mb-1 text-white text-uppercase bg-dark-mode border-dark text-uppercase" id="d15" name="d15" type="text" placeholder="CAMPO 15">
						</div>
						<div class="col-2">
							<input class="form-control mb-1 text-white text-uppercase bg-dark-mode border-dark" id="v15" name="v15" type="text" placeholder="VLR15">
						</div>
					</div>
				...
				<div class="col-md-5">
					...
					<div class="form-group mb-3">
						...
						<input type="form-row" name="obs" class="form-control text-white bg-dark-mode border-dark text-uppercase" placeholder="OBS">
					</div>
					...
					<div class="form-row mb-3">
						...
						<div class="col">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control text-white text-uppercase bg-dark-mode border-dark" name="valor_entrada" placeholder="00,00" aria-describedby="valor_entrada">
					...
					<div class="col">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control text-white text-uppercase bg-dark-mode border-dark" name="valor_labor" placeholder="00,00" aria-describedby="valor_labor">
							<div class="invalid-feedback">Valor da Mão de Obra</div>
						</div>
					</div>
						...
						<div class="col">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control text-white bg-dark-mode border-dark" name="valor_total" placeholder="00,00" aria-describedby="valor_total">
