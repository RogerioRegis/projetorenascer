    ...
    <div id="container">
        <div style="text-align: center">
            <form>
             ...
             href="{{url('order')}}/{{ $order->id }}" target="_blanck">VOLTAR A OS</a>
    ...
    <tbody>
        ...
        <tr class="campos ">
            ...
            <td style="width: 90%; font-size: 4.5mm; text-transform: uppercase; text-align: justify;">
                ...
                a quantia de <strong style="font-size: 5mm; color: navy;">R$ {{ $order->valor_total }}</strong> do(a) Sr(a) <strong style="font-size: 5mm; color: navy">{{ $order->cliente }}</strong> CPF Nº <strong style="font-size: 5mm; color: navy">{{ $order->cpf }}</strong>.
                <br><br>
...
<div style="display:block; float: center;">
    <p style="text-align: center;">
        <font style="font-size: 3mm">
            SIGEFIPRE - Sistema de Gestão e Finenseiro do Projeto Renascer - Impresso em 
