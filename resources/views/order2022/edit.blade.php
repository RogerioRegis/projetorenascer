...
<div class="card shadow mb-4">
	...
	<div class="card-header py-3">
		<h4 class="m-0 font-weight-bold text-uppercase"><i class="fas fa-edit"></i> 
			EDITAR RELATÓRIO - MÊS: <span class="text-primary">{{$vinte_dois_orders->report_month}} </span>ANO: <span class="text-primary">{{$vinte_dois_orders->report_year}}</span>
		</h4>
	</div>
	...
	<div class="card-body text-gray-900 font-weight-bold">
		...
		<form method="post" action="{{ route('order2022.update', $vinte_dois_orders->id) }}" enctype="multipart/form-data">
			@method('PATCH')
			@csrf
			<!-- Bloco 01 -->
			<div class="row">
				<div class="col">
					<div class="form-group">
						...
						<select class="custom-select text-primary" name="report_month">
							<option >{{$vinte_dois_orders->report_month}}</option>
				...
				<div class="col">
					<div class="form-group">
						...
						<input type="file" class="form-control text-primary" name="report" value="{{$vinte_dois_orders->image}}">
					</div>
				</div>

				<div class="col-lg-12">
					<div class="form-group">
						<a href="{{url('order2022')}}" class="btn btn-secondary">
	...
	<div class="embed-responsive embed-responsive-16by9">
		<iframe class="embed-responsive-item" src="{{url('reports')}}/{{$vinte_dois_orders->report_month}}_2022.pdf" allowfullscreen></iframe>
	</div>
