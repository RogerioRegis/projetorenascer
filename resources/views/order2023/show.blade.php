        ...
        <div id="container">
           <div id="midiv">
            <form>
             ...
             href="{{url('order2023')}}" target="_blanck">VOLTAR A OS</a>
         </form>
     </div>
...
<div id="boleto">
    ...
    <table cellspacing="0" cellpadding="0">
        ...
        <tr class="campos" class="header">
            <td>
                <img height="80px" src="{{ url('img/logo_renascer_horizontal.svg') }}"></td>
                <td align="center"> 
   ...
   <div align="center">
    ...
    <table class="header topBorder" cellspacing="0" cellpadding="0">
        <tbody>
            <tr class="titulos">
                <td class="leftBorder rightBorder" style="width: 50%"></td>
                <td class="rightBorder" style="width: 50%; background-color: #d9d9d9"></td>
            </tr>
            <tr class="campos">
                <td class="leftBorder rightBorder" style="font-size: 6mm; text-align: center; color: navy">
                    RECIBO N.º {{ $order->id }}-C
                </td>
                <td class="rightBorder" style="font-size: 6mm; color: navy; background-color: #d9d9d9; text-align: center">
    ...
    <tbody>
        ...
        <tr class="campos ">
            ...
            <td style="width: 90%; font-size: 4.5mm; text-transform: uppercase; text-align: justify;">
                ...
                a quantia de <strong style="font-size: 5mm; color: navy;">R$ {{ $order->valor_total }}</strong> do(a) Sr(a) <strong style="font-size: 5mm; color: navy">{{ $order->cliente }}</strong> CPF Nº <strong style="font-size: 5mm; color: navy">{{ $order->cpf }}</strong>. FONE: {{$order->contato}}.
                <br><br>
                Declaro também que o valor recebido refere-se a compra / serviço(s) prestado(s) de: 
                ...
                no setor de <strong style="font-size: 5mm">{{ $order->categoria }}</strong> e que dou plena e geral quitação pelos serviços que foram prestados.
                <br><br>
        ...
        <tbody>
            ...
            <tr class="campos">
                ...
                <td style="width: 100%; font-size: 4.5mm; text-transform: uppercase; text-align: justify;">
                 BOA VISTA - RR, <strong style="font-size: 5mm; text-align: right"> {{date("d/m/Y", strtotime($order->data_entrada))}} </strong>
