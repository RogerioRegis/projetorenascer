    ...
    <div id="container">
        <div style="text-align: center">
            <form>
             ...
             href="{{url('agenda')}}/{{ $order->id }}" target="_blanck">VOLTAR A ORÇAMENTOS</a>
             ...
             href="{{url('agenda',$order->id)}}/edit">EDITAR</a>
    ...
    <table class="header topBorder" cellspacing="0" cellpadding="0">
        <tbody>
            <tr class="titulos">
                ...
                <td class="rightBorder" style="width: 50%; background-color: navy"></td>
            </tr>
            <tr class="campos">
                <td class="leftBorder rightBorder" style="font-size: 6mm; text-align: center; color: navy">
                    RECIBO N.º {{ $order->id }} - A
                </td>
                <td class="rightBorder" style="font-size: 6mm; color: white; background-color: navy; text-align: center">
